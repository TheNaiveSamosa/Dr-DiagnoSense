...
def prediction_page():
    ...
    gender = st.selectbox("Gender", PTGENDER_CATEGORIES)
    ...
    apoe_allele_type = st.selectbox("APOE Allele Type", APOE_CATEGORIES)
    apoe_genotype = st.selectbox("APOE4 Genotype", APOE_CATEGORIES)
